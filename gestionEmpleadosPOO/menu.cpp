...
void Menu::crearTemporal(string _nombre, int _base, long _identificacion)
{
    ...
    this->nomina.crearEmpleado(new Temporal(_nombre, _base, _identificacion, fecha, salud, pension, liquidacion));
}
...
void Menu::crearContratista(string _nombre, int _base, long _identificacion)
{
    ...
    this->nomina.crearEmpleado(new Contratista(_nombre, _base, _identificacion, numeroPlanilla, retencion, numeroContrato));
}
...
void Menu::crearPlanta(string _nombre, int _base, long _identificacion)
{
    ...
    cout << "Transporte: ";
    cin >> transporte;
    this->nomina.crearEmpleado(new Planta(_nombre, _base, _identificacion, vacaciones, cesantias, salud, pension, transporte));
}
...
void Menu::crearPracticante(string _nombre, int _base, long _identificacion)
{
    ...
    cout << "Salud: ";
    cin >> salud;
    this->nomina.crearEmpleado(new Practicante(_nombre, _base, _identificacion, salud));
}
...
void Menu::eleminarEmpleado()
{
    ...
    long identificacion;
    cin >> identificacion;
    this->nomina.eliminarEmpleado(identificacion);
}
